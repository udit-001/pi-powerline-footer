...
export const PRESETS: Record<StatusLinePreset, PresetDef> = {
  default: {
    leftSegments: ["pi", "model", "thinking", "path", "git", "context_pct", "cache_read"],
    rightSegments: ["token_rate"],
  ...
  nerd: {
    ...
    rightSegments: ["token_in", "token_out", "cache_read", "cache_write", "token_rate", "usage_status", "context_pct", "context_total", "time_spent", "time", "extension_statuses"],
    separator: "powerline",
    colors: NERD_COLORS,
    segmentOptions: {
      model: { showThinkingLevel: false },
